...
//
	...
	#define EXTERN_API_CALLER_FUNCTION_VOID(args_code) \
		void DLLINTERNAL _COMBINE2(api_caller_void_args_, args_code)(const void * func, const void * packed_args)
#else
	#define EXTERN_API_CALLER_FUNCTION(ret_type, args_code) \
		static const api_caller_func_t _COMBINE4(api_caller_, ret_type, _args_, args_code) DLLHIDDEN = (api_caller_func_t)0
	#define EXTERN_API_CALLER_FUNCTION_VOID(args_code) \
		static const api_caller_void_func_t _COMBINE2(api_caller_void_args_, args_code) DLLHIDDEN = (api_caller_void_func_t)0
#endif

EXTERN_API_CALLER_FUNCTION_VOID(ipV);
EXTERN_API_CALLER_FUNCTION_VOID(2pV);
EXTERN_API_CALLER_FUNCTION_VOID(void);
...
EXTERN_API_CALLER_FUNCTION_VOID(2i);
EXTERN_API_CALLER_FUNCTION(int, 2i);
EXTERN_API_CALLER_FUNCTION_VOID(2i2p);
EXTERN_API_CALLER_FUNCTION_VOID(2i2pi2p);
EXTERN_API_CALLER_FUNCTION_VOID(2p);
EXTERN_API_CALLER_FUNCTION(ptr, 2p);
EXTERN_API_CALLER_FUNCTION(int, 2p);
EXTERN_API_CALLER_FUNCTION_VOID(2p2f);
EXTERN_API_CALLER_FUNCTION_VOID(2p2i2p);
EXTERN_API_CALLER_FUNCTION_VOID(2p3fus2uc);
EXTERN_API_CALLER_FUNCTION(ptr, 2pf);
EXTERN_API_CALLER_FUNCTION_VOID(2pfi);
EXTERN_API_CALLER_FUNCTION_VOID(2pi);
EXTERN_API_CALLER_FUNCTION(int, 2pi);
EXTERN_API_CALLER_FUNCTION_VOID(2pui);
EXTERN_API_CALLER_FUNCTION_VOID(2pi2p);
EXTERN_API_CALLER_FUNCTION_VOID(2pif2p);
EXTERN_API_CALLER_FUNCTION(int, 3i);
EXTERN_API_CALLER_FUNCTION_VOID(3p);
EXTERN_API_CALLER_FUNCTION(ptr, 3p);
EXTERN_API_CALLER_FUNCTION(int, 3p);
EXTERN_API_CALLER_FUNCTION_VOID(3p2f2i);
EXTERN_API_CALLER_FUNCTION(int, 3pi2p);
EXTERN_API_CALLER_FUNCTION_VOID(4p);
EXTERN_API_CALLER_FUNCTION(int, 4p);
EXTERN_API_CALLER_FUNCTION_VOID(4pi);
EXTERN_API_CALLER_FUNCTION(int, 4pi);
EXTERN_API_CALLER_FUNCTION_VOID(f);
EXTERN_API_CALLER_FUNCTION_VOID(i);
...
EXTERN_API_CALLER_FUNCTION_VOID(i2p);
EXTERN_API_CALLER_FUNCTION(int, i2p);
EXTERN_API_CALLER_FUNCTION_VOID(i3p);
EXTERN_API_CALLER_FUNCTION_VOID(ip);
EXTERN_API_CALLER_FUNCTION(ushort, ip);
EXTERN_API_CALLER_FUNCTION(int, ip);
EXTERN_API_CALLER_FUNCTION_VOID(ipusf2p2f4i);
EXTERN_API_CALLER_FUNCTION_VOID(p);
...
EXTERN_API_CALLER_FUNCTION_VOID(p2f);
EXTERN_API_CALLER_FUNCTION(int, p2fi);
EXTERN_API_CALLER_FUNCTION_VOID(p2i);
EXTERN_API_CALLER_FUNCTION_VOID(p3i);
EXTERN_API_CALLER_FUNCTION_VOID(p4i);
EXTERN_API_CALLER_FUNCTION_VOID(puc);
EXTERN_API_CALLER_FUNCTION_VOID(pf);
EXTERN_API_CALLER_FUNCTION_VOID(pfp);
EXTERN_API_CALLER_FUNCTION_VOID(pi);
EXTERN_API_CALLER_FUNCTION(ptr, pi);
EXTERN_API_CALLER_FUNCTION(int, pi);
EXTERN_API_CALLER_FUNCTION_VOID(pi2p);
EXTERN_API_CALLER_FUNCTION(int, pi2p2ip);
EXTERN_API_CALLER_FUNCTION_VOID(pip);
EXTERN_API_CALLER_FUNCTION(ptr, pip);
EXTERN_API_CALLER_FUNCTION_VOID(pip2f2i);
EXTERN_API_CALLER_FUNCTION_VOID(pip2f4i2p);
