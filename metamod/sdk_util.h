...
inline const char * DLLINTERNAL ENTITY_KEYVALUE(edict_t *entity, const char *key) {
...
inline const char * DLLINTERNAL SERVERINFO(const char *key) {
...
inline const char * DLLINTERNAL LOCALINFO(const char *key) {
